...
export const translations = {
  en: {
    ...
    buyCoins: "Buy Coins",
    watchAdForCoins: (n: number) => `Watch Ad (+${n} coins)`,
    adNotAvailable: "Ad not available right now",
    adEarned: (n: number) => `+${n} coins earned!`,
    ...
    // Contact consent disclosure
    contactConsentTitle: "Before we access your contacts",
    contactConsentSubtitle: "Please read carefully how your contact data is used.",
    contactConsentBullet1Title: "What we collect",
    contactConsentBullet1Body: "Phone numbers and names from your contact list — nothing else. No emails, photos, addresses or messages.",
    contactConsentBullet2Title: "Why we collect it",
    contactConsentBullet2Body: "Your contacts are matched against our user database so others can discover who has their number saved.",
    contactConsentBullet3Title: "How it is stored",
    contactConsentBullet3Body: "Contact data is stored securely on our servers and is never sold or shared with third parties.",
    contactConsentBullet4Title: "Your rights",
    contactConsentBullet4Body: "You can delete your account and all associated data at any time from your Profile → Delete Account.",
    contactConsentAllow: "Allow & Continue",
    contactConsentDecline: "Not Now",
    contactConsentPrivacyLink: "Read our full Privacy Policy",
  ...
  ar: {
    ...
    buyCoins: "شراء عملات",
    watchAdForCoins: (n: number) => `شاهد إعلاناً (+${n} عملات)`,
    adNotAvailable: "الإعلان غير متاح الآن",
    adEarned: (n: number) => `+${n} عملات مكتسبة!`,
    ...
    contactConsentTitle: "قبل الوصول إلى جهات اتصالك",
    contactConsentSubtitle: "يُرجى قراءة كيفية استخدام بيانات جهات اتصالك بعناية.",
    contactConsentBullet1Title: "ما نجمعه",
    contactConsentBullet1Body: "أرقام الهاتف والأسماء من قائمة جهات اتصالك فقط. لا بريد إلكتروني ولا صور ولا عناوين ولا رسائل.",
    contactConsentBullet2Title: "سبب جمعه",
    contactConsentBullet2Body: "تُطابَق جهات اتصالك مع قاعدة بيانات المستخدمين لدينا حتى يتمكن الآخرون من اكتشاف من حفظ رقمهم.",
    contactConsentBullet3Title: "كيفية تخزينه",
    contactConsentBullet3Body: "تُخزَّن بيانات جهات الاتصال بأمان على خوادمنا ولا تُباع أو تُشارك مع أطراف ثالثة.",
    contactConsentBullet4Title: "حقوقك",
    contactConsentBullet4Body: "يمكنك حذف حسابك وجميع البيانات المرتبطة به في أي وقت من الملف الشخصي ← حذف الحساب.",
    contactConsentAllow: "السماح والمتابعة",
    contactConsentDecline: "ليس الآن",
    contactConsentPrivacyLink: "اقرأ سياسة الخصوصية الكاملة",
  ...
  fr: {
    ...
    watchAdForCoins: (n: number) => `Regarder une pub (+${n} pièces)`,
    adNotAvailable: "Pub non disponible pour l'instant",
    adEarned: (n: number) => `+${n} pièces gagnées !`,
    ...
    contactConsentTitle: "Avant d'accéder à vos contacts",
    contactConsentSubtitle: "Veuillez lire attentivement comment vos données de contacts sont utilisées.",
    contactConsentBullet1Title: "Ce que nous collectons",
    contactConsentBullet1Body: "Les numéros de téléphone et les noms de votre liste de contacts — rien d'autre. Pas d'e-mails, de photos, d'adresses ou de messages.",
    contactConsentBullet2Title: "Pourquoi nous les collectons",
    contactConsentBullet2Body: "Vos contacts sont comparés à notre base d'utilisateurs pour que d'autres puissent découvrir qui a leur numéro enregistré.",
    contactConsentBullet3Title: "Comment ils sont stockés",
    contactConsentBullet3Body: "Les données de contacts sont stockées en toute sécurité sur nos serveurs et ne sont jamais vendues ni partagées avec des tiers.",
    contactConsentBullet4Title: "Vos droits",
    contactConsentBullet4Body: "Vous pouvez supprimer votre compte et toutes les données associées à tout moment depuis Profil → Supprimer le compte.",
    contactConsentAllow: "Autoriser & Continuer",
    contactConsentDecline: "Pas maintenant",
    contactConsentPrivacyLink: "Lire notre politique de confidentialité complète",
