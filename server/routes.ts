...
<head>
  ...
  <script>
    ...
    function returnToApp(){window.location.href='numidapp://payment-complete?status=success&session_id='+encodeURIComponent(_sid);}
...
<head>
  ...
  <script>
    function returnToApp(){window.location.href='numidapp://payment-complete?status=cancel';}
    setTimeout(returnToApp,1500);
